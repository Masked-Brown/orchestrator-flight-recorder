...
*NEGATIVE fixture — deliberately broken, and expected to fail the gate on `record-pairing`.*
*The report carries the fingerprint of a different record from the one supplied.*
