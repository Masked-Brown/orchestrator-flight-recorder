...
*Advice about a later session is appended to the counterfactual.*
...
not undo the binding already made at msg 6. For work of this kind you should name the target explicitly.
