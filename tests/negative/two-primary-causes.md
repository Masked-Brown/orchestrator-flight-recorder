...
*NEGATIVE fixture — deliberately broken, and expected to fail the gate on `primary-cause-count`.*
*Two primary causes are named where there may be only one.*
