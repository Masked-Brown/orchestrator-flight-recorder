...
*NEGATIVE fixture — deliberately broken, and expected to fail the gate on `heading-block`.*
*The provenance lines are missing, so the report cannot be paired with a record.*
