...
*NEGATIVE fixture — deliberately broken, and expected to fail the gate on `failure-mode-file`.*
*A failure mode is invented inside the report, with no file behind it.*
...
Failure mode: instruction-drift
