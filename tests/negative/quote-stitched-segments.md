...
*A quotation runs two separate segments of one message together as though they were one continuous stretch.*
...
The earlier work on the report page, msg 2 (assistant, SAID):

> Report page built on the v1 grid. The v1 grid is in place.
