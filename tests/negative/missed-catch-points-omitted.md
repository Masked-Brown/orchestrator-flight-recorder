...
*NEGATIVE fixture — deliberately broken, and expected to fail the gate on `missed-catch-points`.*
*The missed catch points line is absent, so an omission cannot be told from a finding of none.*
