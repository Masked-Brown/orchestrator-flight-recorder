...
*NEGATIVE fixture — deliberately broken, and expected to fail the gate on `quote-anchor`.*
*A quotation is given with no anchor introducing it.*
...
Where the mismatch is first raised:
